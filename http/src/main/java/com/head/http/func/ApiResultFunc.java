...
/**
*
* 类名称：ApiResultFunc.java <br/>
* 类描述：定义了ApiResult结果转换Func<br/>
* 创建人：shuwen <br/>
            ...
            if (ApiResult.class.isAssignableFrom(cls))
            {
                ...
                try
                {
                        ...
                        && clazz.equals(String.class))
                    {
                        ...
                        apiResult.setCode(0);
                        /*
                         * final Type type = Utils.getType(cls, 0); ApiResult
                         * result = gson.fromJson(json, type); if (result !=
                         * null) { apiResult = result; apiResult.setData((T)
                         * json); } else { apiResult.setMsg("json is null"); }
                         */
                    }
                    else
                    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (result != null)
                    {
                        ...
                        {
                            T data =
                                gson.fromJson(apiResult.getData().toString(),
                                    clazz);
