...
/**
*
* 类名称：UIProgressResponseCallBack.java <br/>
* 类描述：可以直接更新UI的回调<br/>
* 创建人：shuwen <br/>
...
public abstract class UIProgressResponseCallBack
    implements ProgressResponseCallBack
{
    ...
    private static class UIHandler extends Handler
    {
        ...
        public UIHandler(Looper looper,
            UIProgressResponseCallBack uiProgressResponseListener)
        {
            super(looper);
            mUIProgressResponseListenerWeakReference =
                new WeakReference<UIProgressResponseCallBack>(
        ...
        public void handleMessage(Message msg)
        {
            switch (msg.what)
            {
                case RESPONSE_UPDATE:
                    UIProgressResponseCallBack uiProgressResponseListener =
                        mUIProgressResponseListenerWeakReference.get();
    ...
    private final Handler mHandler =
        new UIHandler(Looper.getMainLooper(), this);
    
    @Override
    public void onResponseProgress(long bytesWritten, long contentLength,
        boolean done)
    {
        // 通过Handler发送进度消息
     ...
     * @param done 是否读取完成
     */
    public abstract void onUIResponseProgress(long bytesRead,
    ...
    public class ProgressModel implements Serializable
    {
        ...
        {
            return "ProgressModel{" + "currentBytes=" + currentBytes
