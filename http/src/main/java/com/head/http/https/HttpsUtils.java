...
public class HttpsUtils
{
    ...
    public static SSLParams getSslSocketFactory(InputStream bksFile,
        String password, InputStream[] certificates)
    {
        ...
        try
        {
            ...
            sslContext
                .init(keyManagers, new TrustManager[] {trustManager}, null);
