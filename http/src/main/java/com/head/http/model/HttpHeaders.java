...
{
    public static final String FORMAT_HTTP_DATA =
    ...
    public static final String HEAD_KEY_CONTENT_DISPOSITION =
        "Content-Disposition";
    ...
    /**
     * User-Agent: Mozilla/5.0 (Linux; U; Android 5.0.2; zh-cn; Redmi Note 3
     * Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Mobile
     * Safari/537.36
     */
    public static String getUserAgent()
    {
        if (TextUtils.isEmpty(userAgent))
        {
            ...
            {
                Class<?> sysResCls =
                    Class.forName("com.android.internal.R$string");
                Field webUserAgentField =
                    sysResCls.getDeclaredField("web_user_agent");
                Integer resId = (Integer)webUserAgentField.get(null);
                webUserAgent = HeadHttp.getContext().getString(resId);
            }
            catch (Exception e)
            {
