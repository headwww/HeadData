...
/**
 *
 * 类名称：PersistentCookieStore.java <br/>
 * 类描述：cookie存储器<br/>
 * 创建人：shuwen <br/>
...
public class PersistentCookieStore
{
    ...
    public PersistentCookieStore(Context context)
    {
        ...
        {
            String[] cookieNames =
                TextUtils.split((String)entry.getValue(), ",");
    ...
    public void add(HttpUrl url, Cookie cookie)
    {
        ...
        if (cookie.persistent())
        {
            ...
            prefsWriter.putString(name,
                encodeCookie(new SerializableOkHttpCookies(cookie)));
            prefsWriter.apply();
        }
        else
        {
    ...
    public void addCookies(List<Cookie> cookies)
    {
        for (Cookie cookie : cookies)
        {
            ...
            ConcurrentHashMap<String, Cookie> domainCookies =
                this.cookies.get(domain);
    ...
    protected Cookie decodeCookie(String cookieString)
    {
        ...
        try
        {
            ...
            cookie = ((SerializableOkHttpCookies)objectInputStream.readObject())
                .getCookies();
        }
        catch (IOException e)
        {
        ...
        {
            HttpLog
                .d("ClassNotFoundException in decodeCookie" + e.getMessage());
        }
