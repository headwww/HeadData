...
/**
*
* 类名称：UploadProgressRequestBody.java <br/>
* 类描述：上传请求体<br/>
* 创建人：shuwen <br/>
* 创建时间：2019-10-24 09:18 <br/>
* @version
*/
public class UploadProgressRequestBody extends RequestBody
{
    ...
    public UploadProgressRequestBody(RequestBody delegate,
        ProgressResponseCallBack progressCallBack)
    {
    ...
    protected final class CountingSink extends ForwardingSink
    {
            ...
            throws IOException
        {
            ...
            if (curTime - lastRefreshUiTime >= 100
                || bytesWritten == contentLength)
            {
                progressCallBack.onResponseProgress(bytesWritten,
                    contentLength,
                    bytesWritten == contentLength);
                lastRefreshUiTime = System.currentTimeMillis();
            }
            HttpLog.i("bytesWritten=" + bytesWritten + " ,totalBytesCount="
                + contentLength);
        }
    }
