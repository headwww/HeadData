...
public class DBHelper {
    ...
    public List<DBData> findData(String tableName, DBData findConditions, HeadDB.SORT sort, List<String> whereConditions, long start, long count) {
        synchronized (DBHelper.class) {
            if (db == null) {
                error("警告：数据库未初始化");
