...
import com.head.db.data.DBData;
import com.head.db.util.DBHelper;
...
public class HeadDB {
    ...
    public static HeadDB getTable(String tableName) {
        HeadDB db = new HeadDB();
        db.create(tableName);
        return db;
    }
     ...
     * @return 继续条件
     */
    public HeadDB add(DBData dbData) {
     ...
     * @return 继续条件
     */
    public HeadDB limit(long start, long count) {
        limitStart = start;
        limitCount = count;
        return this;
    }
     ...
     * @return 继续条件
     */
    public HeadDB subData(long start, long count) {
     ...
     * @return 继续条件
     */
    public HeadDB where(String whereSQL) {
     ...
     * @return 继续条件
     */
    public HeadDB whereEqual(String key, Serializable value) {
        if (whereConditions == null) {
            whereConditions = new ArrayList<>();
        }
     ...
     * @return 继续条件
     */
    public HeadDB whereNot(String key, Serializable value) {
        if (whereConditions == null) {
            whereConditions = new ArrayList<>();
        }
     ...
     * @return 继续条件
     */
    public HeadDB whereGreater(String key, Serializable value) {
        if (whereConditions == null) {
            whereConditions = new ArrayList<>();
        }
        this.whereConditions.add(key + ">\'" + value + "\'");
     ...
     * @return 继续条件
     */
    public HeadDB whereLess(String key, Serializable value) {
        if (whereConditions == null) {
            whereConditions = new ArrayList<>();
        }
        this.whereConditions.add(key + "<\'" + value + "\'");
     ...
     * @return 继续条件
     */
    public HeadDB whereLike(String key, Serializable value) {
        if (whereConditions == null) {
            whereConditions = new ArrayList<>();
        }
     ...
     * @return 继续条件
     */
    public HeadDB setSort(SORT sort) {
        this.sort = sort;
        return this;
    }
     ...
     * @return 继续条件
     */
    public HeadDB setAllowDuplicate(boolean allowDuplicate) {
     ...
     * @return 继续条件
     */
    public HeadDB setDEBUGMODE(boolean showLogs) {
        DBHelper.DEBUGMODE = showLogs;
        return this;
    }
    ...
    private void log(Object o) {
        if (DBHelper.DEBUGMODE) {
            Log.i("HeadDB>>>", o.toString());
        }
    }
    
    private void error(Object o) {
        if (DBHelper.DEBUGMODE) {
            Log.e("HeadDB>>>", o.toString());
        }
    }
}
